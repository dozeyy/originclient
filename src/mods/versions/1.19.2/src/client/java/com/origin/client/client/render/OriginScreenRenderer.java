	...
	public static void renderTitleAccountChip(Gfx guiGraphics) {
		...
		try {
			...
			try {
				...
				net.minecraft.resources.ResourceLocation skin = mc.getSkinManager().getInsecureSkinLocation(profile);
				RenderSystem.setShaderTexture(0, skin);
				net.minecraft.client.gui.components.PlayerFaceRenderer.draw(guiGraphics.pose(), hx, hy, head);
				drewHead = true;
