...
public final class ThickLine {
	...
	private static void quad(VertexConsumer q, PoseStack.Pose pose,
			...
			float r, float g, float b, float a) {
		q.addVertex(pose, x0, y0, z0).setColor(r, g, b, a);
		q.addVertex(pose, x1, y1, z1).setColor(r, g, b, a);
		q.addVertex(pose, x2, y2, z2).setColor(r, g, b, a);
		q.addVertex(pose, x3, y3, z3).setColor(r, g, b, a);
	}
}
