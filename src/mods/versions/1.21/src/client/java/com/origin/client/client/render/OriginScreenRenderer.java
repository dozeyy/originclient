...
public final class OriginScreenRenderer {
	...
	public static boolean renderTitleBackground(GuiGraphics guiGraphics) {
		...
		try {
			...
			// otherwise every widget after this renders into the wrong target and
			// the screen looks empty except for the panorama. Vanilla's
			// Screen.renderBlurredBackground does these two calls as a pair.
