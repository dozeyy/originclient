...
// declared IDENTICALLY in both stages — with the member missing the program
// fails to link and the text silently never draws. Verified against this era's
// own position_tex_color.fsh (see ColorGrade's identical gotcha).
