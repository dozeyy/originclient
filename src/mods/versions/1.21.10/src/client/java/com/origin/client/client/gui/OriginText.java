...
public final class OriginText {
	public static final FontDescription REGULAR =
			new FontDescription.Resource(ResourceLocation.fromNamespaceAndPath("originclient", "inter"));
	public static final FontDescription SEMIBOLD =
			new FontDescription.Resource(ResourceLocation.fromNamespaceAndPath("originclient", "inter_semibold"));
