...
public final class OriginSdfFont {
	...
	private record MsdfTextRenderState(
		...
		public TextureSetup textureSetup() {
			try {
				// PER-VERSION DELTA: 1.21.11 picks the sampler explicitly via
				// RenderSystem.getSamplerCache(); that API doesn't exist yet on
				// 1.21.10, which takes the single-argument form (as 1.21.8 does).
