...
public final class OriginTabList {
	...
	private static void drawHearts(GuiGraphics g, int rightX, int y, int score) {
		...
		for (int i = 0; i < full; i++) {
			g.blitSprite(net.minecraft.client.renderer.RenderType::guiTextured, HEART_CONTAINER, sx + i * 8, y, 9, 9);
			g.blitSprite(net.minecraft.client.renderer.RenderType::guiTextured, HEART_FULL, sx + i * 8, y, 9, 9);
		}
		if (half) {
			g.blitSprite(net.minecraft.client.renderer.RenderType::guiTextured, HEART_CONTAINER, sx + full * 8, y, 9, 9);
			g.blitSprite(net.minecraft.client.renderer.RenderType::guiTextured, HEART_HALF, sx + full * 8, y, 9, 9);
		}
	}
