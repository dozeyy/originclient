...
public final class Mods {
	...
	// a mod definition (Java-8 final class, was a record).
	public static final class Mod {
		private final String id; private final String name; private final String description;
		private final boolean defaultOn; private final List<ModOption> options;
		public Mod(String id, String name, String description, boolean defaultOn, List<ModOption> options) {
			this.id = id; this.name = name; this.description = description; this.defaultOn = defaultOn; this.options = options;
		}
		public String id() { return id; }
		public String name() { return name; }
		public String description() { return description; }
		public boolean defaultOn() { return defaultOn; }
		public List<ModOption> options() { return options; }
	}
	...
	public static final List<ModOption> GENERAL_SETTINGS = java.util.Arrays.asList(
	...
	public static final List<ModOption> PERFORMANCE_SETTINGS = java.util.Arrays.asList(
	...
	private static void add(String id, String name, String description, boolean defaultOn, ModOption... options) {
		ALL.add(new Mod(id, name, description, defaultOn, java.util.Arrays.asList(options)));
	}
	...
	public static boolean on(String modId) {
		com.google.gson.JsonElement v = raw(modId).get("enabled");
		if (v != null) {
	...
	public static boolean bool(String modId, String key) {
		com.google.gson.JsonElement v = raw(modId).get(key);
		if (v != null) {
			return v.getAsBoolean();
		}
	...
	public static boolean metaBool(String key, boolean def) {
		...
		com.google.gson.JsonElement v = ModsConfig.META.get(key);
	...
	private static void migrateOnce() {
		...
		com.origin.client.client.OriginFeatures legacy = OriginClientMod.FEATURES;
