...
public final class OriginButtonRenderer {
	...
	private static void render0(Gfx guiGraphics, AbstractButton button) {
		...
		// there is no isHovered() method — isHovered() is this era's
	...
	private static String readAll(InputStream in) throws Exception {
		return new String(com.origin.client.client.IoCompat.readAllBytes(in), java.nio.charset.StandardCharsets.UTF_8);
	}
