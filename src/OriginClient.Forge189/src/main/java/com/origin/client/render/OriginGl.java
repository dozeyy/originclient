...
/**
 * Fixed-function-GL primitive layer for 1.8.9 — the era equivalent of the
...
public final class OriginGl {
    ...
    /** Filled rectangle, ARGB. Gui.drawRect handles the alpha blend/reset. */
    ...
    /** Load a classpath PNG into a registered DynamicTexture; returns its id (null on failure). */
    ...
    /** Draw a whole texture into a dst rect with an (r,g,b,a) tint. */
    ...
    /** Draw a sub-region (u,v in 0..1) of a texture into a dst rect with an (r,g,b,a) tint. */
    public static void blitUV(ResourceLocation id, double x, double y, double w, double h,
        ...
        wr.begin(7, DefaultVertexFormats.POSITION_TEX); // GL_QUADS
